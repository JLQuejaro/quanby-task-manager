...
interface ClearArchiveDialogProps {
  open: boolean;
...
export function ClearArchiveDialog({ open, onOpenChange, onConfirm, taskCount }: ClearArchiveDialogProps) {
  return (
      ...
      <AlertDialogContent className="bg-white dark:bg-gray-900 border-2 border-red-300 dark:border-red-800">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-gray-600 dark:text-gray-400">
            Are you sure you want to permanently delete <span className="font-semibold text-gray-900 dark:text-gray-100">ALL {taskCount} archived {taskCount === 1 ? 'task' : 'tasks'}</span>?
            <br />
